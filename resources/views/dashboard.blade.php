    ...
    <div role="main">
        <div class="row">
            <div class="tile_count">
                <div class="col-lg-4 tile_stats_count">
                    <span class="count_top"><i class="fa fa-user"></i> Total Buku</span>
                    <div class="count">2500</div>
                    <span class="count_bottom"><i class="green">4% </i> From last Week</span>
                </div>
                <div class="col-lg-4 tile_stats_count">
                    <span class="count_top"><i class="fa fa-clock-o"></i> Buku Keluar</span>
        ...
        <div class="row" style="display: block;">
            ...
            <div class="col-md-4 col-sm-4  ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Form Pengunjung <small>Silahkan di isi</small></h2>
                  <ul class="nav navbar-right panel_toolbox">
